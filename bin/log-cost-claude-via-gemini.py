...
# ///
"""log-cost-claude-via-gemini — Google AI Pro 플랜의 Claude (via Gemini) 단계 cost_details 이벤트 기록.

check-usage --json의 "gemini" buckets 중 claude 항목(또는 claude provider)의 five_hour/seven_day utilization을
조회해 대상 이슈의 agent-stats.json cost_details에 이벤트를 append한다.

사용법:
    log-cost-claude-via-gemini.py [--dryrun] <repo-path> <issue-N|autofix-N> "<description>"
"""
